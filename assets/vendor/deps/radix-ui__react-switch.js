...
function createSlot(ownerName) {
  ...
  const Slot2 = React7.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx2(SlotClone, { ...slotProps, ref: forwardedRef, children: React7.isValidElement(newElement) ? React7.cloneElement(newElement, undefined, newChildren) : null });
    }
...
var Switch = React9.forwardRef((props, forwardedRef) => {
  const {
    __scopeSwitch,
    name,
    checked: checkedProp,
  ...
  return /* @__PURE__ */ jsxs(SwitchProvider, { scope: __scopeSwitch, checked, disabled, children: [
    /* @__PURE__ */ jsx4(Primitive.button, {
      type: "button",
      role: "switch",
    ...
    isFormControl && /* @__PURE__ */ jsx4(SwitchBubbleInput, {
      control: button,
...
var SwitchThumb = React9.forwardRef((props, forwardedRef) => {
  const { __scopeSwitch, ...thumbProps } = props;
  const context = useSwitchContext(THUMB_NAME, __scopeSwitch);
  return /* @__PURE__ */ jsx4(Primitive.span, {
