...
var Arrow = React13.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx6(Primitive.svg, {
    ...arrowProps,
    ref: forwardedRef,
    width,
    height,
...
function useSize(element) {
  const [size4, setSize] = React14.useState(undefined);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperAnchor = React15.forwardRef((props, forwardedRef) => {
...
var PopperContent = React15.forwardRef((props, forwardedRef) => {
  const {
    __scopePopper,
    side = "bottom",
    sideOffset = 0,
  ...
  return /* @__PURE__ */ jsx7("div", {
    ...
    dir: props.dir,
    children: /* @__PURE__ */ jsx7(PopperContentProvider, {
      scope: __scopePopper,
      placedSide,
...
import { useState as useState12, useCallback as useCallback6, useEffect as useEffect12, useLayoutEffect as useLayoutEffect6 } from "react";
...
var RemoveScroll = React26.forwardRef(function(props, parentRef) {
  ...
  return React26.createElement(React26.Fragment, null, enabled && React26.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }), forwardProps ? React26.cloneElement(React26.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React26.createElement(Container, __assign({}, containerProps, { className, ref: containerRef }), children));
});
...
function RemoveScrollSideCar(props) {
  ...
  return React29.createElement(React29.Fragment, null, inert ? React29.createElement(Style2, { styles: generateStyle(id) }) : null, removeScrollBar ? React29.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null);
}
...
var Popover = (props) => {
  ...
  return /* @__PURE__ */ jsx9(Root2, { ...popperScope, children: /* @__PURE__ */ jsx9(PopoverProvider, {
...
var PopoverAnchor = React31.forwardRef((props, forwardedRef) => {
...
var PopoverTrigger = React31.forwardRef((props, forwardedRef) => {
  const { __scopePopover, ...triggerProps } = props;
  const context = usePopoverContext(TRIGGER_NAME, __scopePopover);
  const popperScope = usePopperScope(__scopePopover);
  const composedTriggerRef = useComposedRefs(forwardedRef, context.triggerRef);
  const trigger = /* @__PURE__ */ jsx9(Primitive.button, {
    type: "button",
...
var PopoverContent = React31.forwardRef((props, forwardedRef) => {
...
var PopoverContentModal = React31.forwardRef((props, forwardedRef) => {
  const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
  ...
  return /* @__PURE__ */ jsx9(Combination_default, { as: Slot, allowPinchZoom: true, children: /* @__PURE__ */ jsx9(PopoverContentImpl, {
    ...props,
    ref: composedRefs,
...
var PopoverContentNonModal = React31.forwardRef((props, forwardedRef) => {
  const context = usePopoverContext(CONTENT_NAME2, props.__scopePopover);
  const hasInteractedOutsideRef = React31.useRef(false);
  const hasPointerDownOutsideRef = React31.useRef(false);
  return /* @__PURE__ */ jsx9(PopoverContentImpl, {
    ...props,
    ref: forwardedRef,
    trapFocus: false,
    disableOutsidePointerEvents: false,
...
var PopoverContentImpl = React31.forwardRef((props, forwardedRef) => {
  const {
    __scopePopover,
    trapFocus,
    onOpenAutoFocus,
  ...
  const popperScope = usePopperScope(__scopePopover);
  useFocusGuards();
  return /* @__PURE__ */ jsx9(FocusScope, {
    asChild: true,
    loop: true,
    trapped: trapFocus,
    onMountAutoFocus: onOpenAutoFocus,
    onUnmountAutoFocus: onCloseAutoFocus,
    children: /* @__PURE__ */ jsx9(DismissableLayer, {
      asChild: true,
      disableOutsidePointerEvents,
      onInteractOutside,
      onEscapeKeyDown,
      ...
      children: /* @__PURE__ */ jsx9(Content, {
        "data-state": getState(context.open),
        role: "dialog",
...
var PopoverClose = React31.forwardRef((props, forwardedRef) => {
  const { __scopePopover, ...closeProps } = props;
  const context = usePopoverContext(CLOSE_NAME, __scopePopover);
  return /* @__PURE__ */ jsx9(Primitive.button, {
    type: "button",
    ...closeProps,
    ref: forwardedRef,
...
var PopoverArrow = React31.forwardRef((props, forwardedRef) => {
