...
function useStateManager(_ref) {
  ...
  var _useState = useState(propsInputValue !== undefined ? propsInputValue : defaultInputValue), _useState2 = _slicedToArray(_useState, 2), stateInputValue = _useState2[0], setStateInputValue = _useState2[1];
  var _useState3 = useState(propsMenuIsOpen !== undefined ? propsMenuIsOpen : defaultMenuIsOpen), _useState4 = _slicedToArray(_useState3, 2), stateMenuIsOpen = _useState4[0], setStateMenuIsOpen = _useState4[1];
  var _useState5 = useState(propsValue !== undefined ? propsValue : defaultValue), _useState6 = _slicedToArray(_useState5, 2), stateValue = _useState6[0], setStateValue = _useState6[1];
  var onChange = useCallback(function(value2, actionMeta) {
...
import { useMemo as useMemo2, Fragment as Fragment3, useRef as useRef3, useCallback as useCallback3, useEffect, Component } from "react";
...
var jsx = function jsx2(type, props) {
  ...
  if (props == null || !hasOwn.call(props, "css")) {
    return React3.createElement.apply(undefined, args);
  }
...
var Global = /* @__PURE__ */ withEmotionCache(function(props, cache) {
  ...
  var serialized = serializeStyles([styles], undefined, React3.useContext(ThemeContext));
...
import { useContext as useContext4, useRef as useRef2, useState as useState2, useMemo, useCallback as useCallback2, createContext as createContext2 } from "react";
...
var getStyleProps = function getStyleProps2(props, name, classNamesState) {
  var { cx, getStyles, getClassNames, className } = props;
  return {
...
function getMenuPlacement(_ref) {
  var { maxHeight: preferredMaxHeight, menuEl, minHeight, placement: preferredPlacement, shouldScroll, isFixedPosition, controlHeight } = _ref;
...
var menuCSS = function menuCSS2(_ref2, unstyled) {
  var _objectSpread22;
  var { placement, theme: _ref2$theme } = _ref2, borderRadius = _ref2$theme.borderRadius, spacing = _ref2$theme.spacing, colors = _ref2$theme.colors;
...
var PortalPlacementContext = /* @__PURE__ */ createContext2(null);
var MenuPlacer = function MenuPlacer2(props) {
  var { children, minMenuHeight, maxMenuHeight, menuPlacement, menuPosition, menuShouldScrollIntoView, theme } = props;
  var _ref3 = useContext4(PortalPlacementContext) || {}, setPortalPlacement = _ref3.setPortalPlacement;
  var ref = useRef2(null);
  var _useState = useState2(maxMenuHeight), _useState2 = _slicedToArray(_useState, 2), maxHeight = _useState2[0], setMaxHeight = _useState2[1];
  var _useState3 = useState2(null), _useState4 = _slicedToArray(_useState3, 2), placement = _useState4[0], setPlacement = _useState4[1];
  ...
  index(function() {
    ...
    setPortalPlacement === null || setPortalPlacement === undefined || setPortalPlacement(state.placement);
...
var Menu = function Menu2(props) {
  var { children, innerRef, innerProps } = props;
...
var MenuList = function MenuList2(props) {
  var { children, innerProps, innerRef, isMulti } = props;
...
var NoOptionsMessage = function NoOptionsMessage2(_ref6) {
  var _ref6$children = _ref6.children, children = _ref6$children === undefined ? "No options" : _ref6$children, innerProps = _ref6.innerProps, restProps = _objectWithoutProperties(_ref6, _excluded$3);
...
var LoadingMessage = function LoadingMessage2(_ref7) {
  var _ref7$children = _ref7.children, children = _ref7$children === undefined ? "Loading..." : _ref7$children, innerProps = _ref7.innerProps, restProps = _objectWithoutProperties(_ref7, _excluded2$1);
  return jsx("div", _extends({}, getStyleProps(_objectSpread2(_objectSpread2({}, restProps), {}, {
    children,
    innerProps
  }), "loadingMessage", {
...
var menuPortalCSS = function menuPortalCSS2(_ref8) {
  var { rect, offset: offset2, position: position2 } = _ref8;
  return {
    left: rect.left,
    position: position2,
    top: offset2,
...
var MenuPortal = function MenuPortal2(props) {
  ...
  var menuPortalRef = useRef2(null);
  var cleanupRef = useRef2(null);
  var _useState5 = useState2(coercePlacement(menuPlacement)), _useState6 = _slicedToArray(_useState5, 2), placement = _useState6[0], setPortalPlacement = _useState6[1];
  var portalPlacementContext = useMemo(function() {
    return {
      setPortalPlacement
    };
  }, []);
  var _useState7 = useState2(null), _useState8 = _slicedToArray(_useState7, 2), computedPosition = _useState8[0], setComputedPosition = _useState8[1];
  var updateComputedPosition = useCallback2(function() {
    ...
    if (offset2 !== (computedPosition === null || computedPosition === undefined ? undefined : computedPosition.offset) || rect.left !== (computedPosition === null || computedPosition === undefined ? undefined : computedPosition.rect.left) || rect.width !== (computedPosition === null || computedPosition === undefined ? undefined : computedPosition.rect.width)) {
      setComputedPosition({
        offset: offset2,
        rect
      });
  ...
  var runAutoUpdate = useCallback2(function() {
  ...
  var setMenuPortalElement = useCallback2(function(menuPortalElement) {
...
var SelectContainer = function SelectContainer2(props) {
  var { children, innerProps, isDisabled, isRtl } = props;
  return jsx("div", _extends({}, getStyleProps(props, "container", {
    "--is-disabled": isDisabled,
    "--is-rtl": isRtl
  }), innerProps), children);
};
var valueContainerCSS = function valueContainerCSS2(_ref2, unstyled) {
...
var ValueContainer = function ValueContainer2(props) {
  var { children, innerProps, isMulti, hasValue } = props;
...
var baseCSS = function baseCSS2(_ref3, unstyled) {
  var { isFocused, theme: _ref3$theme } = _ref3, baseUnit = _ref3$theme.spacing.baseUnit, colors = _ref3$theme.colors;
  return _objectSpread2({
...
var indicatorSeparatorCSS = function indicatorSeparatorCSS2(_ref4, unstyled) {
  var { isDisabled, theme: _ref4$theme } = _ref4, baseUnit = _ref4$theme.spacing.baseUnit, colors = _ref4$theme.colors;
  return _objectSpread2({
...
var loadingIndicatorCSS = function loadingIndicatorCSS2(_ref5, unstyled) {
  var { isFocused, size: size2, theme: _ref5$theme } = _ref5, colors = _ref5$theme.colors, baseUnit = _ref5$theme.spacing.baseUnit;
  return _objectSpread2({
...
var LoadingDot = function LoadingDot2(_ref6) {
  var { delay, offset: offset2 } = _ref6;
  return jsx("span", {
    css: /* @__PURE__ */ css({
      ...
      marginLeft: offset2 ? "1em" : undefined,
      height: "1em",
      verticalAlign: "top",
      width: "1em"
...
var LoadingIndicator = function LoadingIndicator2(_ref7) {
  var { innerProps, isRtl, size: _ref7$size } = _ref7, size2 = _ref7$size === undefined ? 4 : _ref7$size, restProps = _objectWithoutProperties(_ref7, _excluded2);
  return jsx("div", _extends({}, getStyleProps(_objectSpread2(_objectSpread2({}, restProps), {}, {
    innerProps,
    isRtl,
    size: size2
...
var css$1 = function css2(_ref, unstyled) {
  var { isDisabled, isFocused, theme: _ref$theme } = _ref, colors = _ref$theme.colors, borderRadius = _ref$theme.borderRadius, spacing = _ref$theme.spacing;
  return _objectSpread2({
    label: "control",
    alignItems: "center",
    cursor: "default",
...
var Control = function Control2(props) {
  var { children, isDisabled, isFocused, innerRef, innerProps, menuIsOpen } = props;
...
var Group = function Group2(props) {
  var { children, cx, getStyles, getClassNames, Heading, headingProps, innerProps, label, theme, selectProps } = props;
...
var inputCSS = function inputCSS2(_ref, unstyled) {
  var { isDisabled, value, theme: _ref$theme } = _ref, spacing = _ref$theme.spacing, colors = _ref$theme.colors;
...
var MultiValueGeneric = function MultiValueGeneric2(_ref4) {
  var { children, innerProps } = _ref4;
  return jsx("div", innerProps, children);
};
var MultiValueContainer = MultiValueGeneric;
var MultiValueLabel = MultiValueGeneric;
function MultiValueRemove(_ref5) {
  var { children, innerProps } = _ref5;
  return jsx("div", _extends({
    role: "button"
...
var MultiValue = function MultiValue2(props) {
  var { children, components, data, innerProps, isDisabled, removeProps: removeProps3, selectProps } = props;
  var { Container, Label, Remove } = components;
...
var optionCSS = function optionCSS2(_ref, unstyled) {
  var { isDisabled, isFocused, isSelected, theme: _ref$theme } = _ref, spacing = _ref$theme.spacing, colors = _ref$theme.colors;
  return _objectSpread2({
    label: "option",
    cursor: "default",
    display: "block",
...
var Option = function Option2(props) {
  var { children, isDisabled, isFocused, isSelected, innerRef, innerProps } = props;
...
var css3 = function css4(_ref, unstyled) {
  var { isDisabled, theme: _ref$theme } = _ref, spacing = _ref$theme.spacing, colors = _ref$theme.colors;
  return _objectSpread2({
    label: "singleValue",
    gridArea: "1 / 1 / 2 / 3",
    maxWidth: "100%",
...
var SingleValue = function SingleValue2(props) {
  var { children, isDisabled, innerProps } = props;
...
var defaultAriaLiveMessages = {
  guidance: function guidance(props) {
    var { isSearchable, isMulti, tabSelectsValue, context, isInitialFocus } = props;
    switch (context) {
      case "menu":
  ...
  onChange: function onChange(props) {
    var { action, label: _props$label } = props, label = _props$label === undefined ? "" : _props$label, labels = props.labels, isDisabled = props.isDisabled;
    switch (action) {
  ...
  onFocus: function onFocus(props) {
    var { context, focused, options: options2, label: _props$label2 } = props, label = _props$label2 === undefined ? "" : _props$label2, selectValue = props.selectValue, isDisabled = props.isDisabled, isSelected = props.isSelected, isAppleDevice = props.isAppleDevice;
  ...
  onFilter: function onFilter(props) {
    var { inputValue, resultsMessage } = props;
    return "".concat(resultsMessage).concat(inputValue ? " for search term " + inputValue : "", ".");
  }
};
var LiveRegion = function LiveRegion2(props) {
  var { ariaSelection, focusedOption, focusedValue, focusableOptions, isFocused, selectValue, selectProps, id, isAppleDevice } = props;
  ...
  var messages = useMemo2(function() {
    return _objectSpread2(_objectSpread2({}, defaultAriaLiveMessages), ariaLiveMessages || {});
  }, [ariaLiveMessages]);
  var ariaSelected = useMemo2(function() {
    var message = "";
  ...
  var ariaFocused = useMemo2(function() {
    var focusMsg = "";
  ...
  var ariaResults = useMemo2(function() {
    var resultsMsg = "";
  ...
  var ariaGuidance = useMemo2(function() {
    var guidanceMsg = "";
  ...
  var ScreenReaderText = jsx(Fragment3, null, jsx("span", {
    id: "aria-selection"
  ...
  return jsx(Fragment3, null, jsx(A11yText$1, {
    id
...
var _excluded5 = ["innerRef"];
function DummyInput(_ref3) {
  var innerRef = _ref3.innerRef, props = _objectWithoutProperties(_ref3, _excluded5);
...
function useScrollCapture(_ref3) {
  ...
  var isBottom = useRef3(false);
  var isTop = useRef3(false);
  var touchStart = useRef3(0);
  var scrollTarget = useRef3(null);
  ...
  var onWheel = useCallback3(function(event) {
    handleEventDelta(event, event.deltaY);
  }, [handleEventDelta]);
  var onTouchStart = useCallback3(function(event) {
    touchStart.current = event.changedTouches[0].clientY;
  }, []);
  var onTouchMove = useCallback3(function(event) {
    var deltaY = touchStart.current - event.changedTouches[0].clientY;
    handleEventDelta(event, deltaY);
  }, [handleEventDelta]);
  var startListening = useCallback3(function(el) {
    if (!el)
      return;
  ...
  var stopListening = useCallback3(function(el) {
    if (!el)
      return;
...
function useScrollLock(_ref3) {
  ...
  var removeScrollLock = useCallback3(function(touchScrollTarget) {
    if (!canUseDOM)
      return;
    var target = document.body;
    var targetStyle = target && target.style;
...
function ScrollManager(_ref3) {
  var { children, lockEnabled, captureEnabled: _ref$captureEnabled } = _ref3, captureEnabled = _ref$captureEnabled === undefined ? true : _ref$captureEnabled, onBottomArrive = _ref3.onBottomArrive, onBottomLeave = _ref3.onBottomLeave, onTopArrive = _ref3.onTopArrive, onTopLeave = _ref3.onTopLeave;
  ...
  return jsx(Fragment3, null, lockEnabled && jsx("div", {
...
var RequiredInput = function RequiredInput2(_ref3) {
  var { name, onFocus: onFocus2 } = _ref3;
  return jsx("input", {
    required: true,
    name,
    tabIndex: -1,
...
function isFocusable(props, categorizedOption) {
  var _props$inputValue = props.inputValue, inputValue = _props$inputValue === undefined ? "" : _props$inputValue;
  var { data, isSelected, label, value } = categorizedOption;
...
function getNextFocusedValue(state, nextSelectValue) {
  var { focusedValue, selectValue: lastSelectValue } = state;
...
var shouldHideSelectedOptions = function shouldHideSelectedOptions2(props) {
  var { hideSelectedOptions, isMulti } = props;
...
var Select = /* @__PURE__ */ function(_Component) {
  ...
  _createClass(Select2, [{
    ...
    value: function getCommonProps() {
      ...
      var { isMulti, isRtl, options: options2 } = props;
    ...
    value: function renderMenu() {
      ...
      var render = function render(props, id) {
        var { type, data, isDisabled, isSelected, label, value } = props;
        ...
        var innerProps = {
          ...
          tabIndex: -1,
          role: "option",
          "aria-selected": _this4.state.isAppleDevice ? undefined : isSelected
        };
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function(item) {
          if (item.type === "group") {
            var { data: _data, options: options2, index: groupIndex } = item;
      ...
      var menuElement = /* @__PURE__ */ React4.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function(_ref4) {
        var { ref, placerProps: _ref4$placerProps } = _ref4, placement = _ref4$placerProps.placement, maxHeight = _ref4$placerProps.maxHeight;
    ...
    value: function getDerivedStateFromProps(props, state) {
      var { prevProps, clearFocusValueOnUpdate, inputIsHiddenAfterUpdate, ariaSelection, isFocused, prevWasFocused, instancePrefix } = state;
      var { options: options2, value, menuIsOpen, inputValue, isMulti } = props;
...
// node_modules/react-select/dist/react-select.esm.js
import"react-dom";
var StateManagedSelect = /* @__PURE__ */ forwardRef3(function(props, ref) {
...
var NonceProvider = function(_ref3) {
  var { nonce, children, cacheKey } = _ref3;
  var emotionCache = useMemo3(function() {
    return createCache({
      key: cacheKey,
      nonce
    });
  }, [cacheKey, nonce]);
  return /* @__PURE__ */ React5.createElement(CacheProvider, {
    value: emotionCache
  }, children);
};
export {
