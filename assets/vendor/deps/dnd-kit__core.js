...
function useDndMonitorProvider() {
  const [listeners] = useState2(() => new Set);
...
function useSensors() {
  ...
  return useMemo2(() => [...sensors].filter((sensor) => sensor != null), [...sensors]);
}
...
function useDragOverlayMeasuring(_ref) {
  ...
  const handleNodeChange = useCallback3((element) => {
    ...
    resizeObserver == null || resizeObserver.disconnect();
    if (node) {
      resizeObserver == null || resizeObserver.observe(node);
    }
...
function RestoreFocus(_ref) {
  ...
  const previousActiveId = usePrevious(active == null ? undefined : active.id);
  useEffect2(() => {
    if (disabled) {
      return;
    }
...
function useLayoutShiftScrollCompensation(_ref) {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const node = activeNode == null ? undefined : activeNode.node.current;
...
var DndContext = /* @__PURE__ */ memo(function DndContext2(_ref) {
  ...
  const active = useMemo2(() => {
    ...
    return activeId != null ? {
      id: activeId,
      data: (_node$data = node == null ? undefined : node.data) != null ? _node$data : defaultData,
      rect: activeRects
    } : null;
  }, [activeId, node]);
  ...
  const instantiateSensor = useCallback3((event, _ref2) => {
    let {
      sensor: Sensor,
      options
    } = _ref2;
...
function AnimationManager(_ref) {
  ...
  useIsomorphicLayoutEffect(() => {
    ...
    const key = clonedChildren == null ? undefined : clonedChildren.key;
    const id = clonedChildren == null ? undefined : clonedChildren.props.id;
    if (key == null || id == null) {
...
var PositionedOverlay = /* @__PURE__ */ forwardRef((_ref, ref) => {
  ...
  const styles = {
    ...
    transformOrigin: adjustScale2 && activatorEvent ? getRelativeTransformOrigin(activatorEvent, rect) : undefined,
...
function createDefaultDropAnimation(options) {
  ...
  return (_ref4) => {
    ...
    const cleanup = sideEffects == null ? undefined : sideEffects({
      active,
      dragOverlay,
      ...rest
    });
...
var DragOverlay = /* @__PURE__ */ React2.memo((_ref) => {
  ...
  const key2 = useKey(active == null ? undefined : active.id);
