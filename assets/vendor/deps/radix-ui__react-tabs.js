...
// node_modules/@radix-ui/react-id/dist/index.mjs
var useReactId = React6[" useId ".trim().toString()] || (() => {
  return;
});
var count = 0;
...
var RovingFocusGroup = React11.forwardRef((props, forwardedRef) => {
...
var RovingFocusGroupImpl = React11.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx6(RovingFocusProvider, {
    scope: __scopeRovingFocusGroup,
    orientation,
    dir: direction,
    loop,
    currentTabStopId,
    onItemFocus: React11.useCallback((tabStopId) => setCurrentTabStopId(tabStopId), [setCurrentTabStopId]),
    onItemShiftTab: React11.useCallback(() => setIsTabbingBackOut(true), []),
    onFocusableItemAdd: React11.useCallback(() => setFocusableItemsCount((prevCount) => prevCount + 1), []),
    onFocusableItemRemove: React11.useCallback(() => setFocusableItemsCount((prevCount) => prevCount - 1), []),
    children: /* @__PURE__ */ jsx6(Primitive.div, {
...
var RovingFocusGroupItem = React11.forwardRef((props, forwardedRef) => {
  const {
    __scopeRovingFocusGroup,
    focusable = true,
    active = false,
  ...
  return /* @__PURE__ */ jsx6(Collection.ItemSlot, {
    scope: __scopeRovingFocusGroup,
    id,
    focusable,
    active,
    children: /* @__PURE__ */ jsx6(Primitive.span, {
...
var Tabs = React13.forwardRef((props, forwardedRef) => {
  const {
    __scopeTabs,
    value: valueProp,
    onValueChange,
  ...
  return /* @__PURE__ */ jsx7(TabsProvider, {
    scope: __scopeTabs,
    baseId: useId(),
    value,
    ...
    dir: direction,
    activationMode,
    children: /* @__PURE__ */ jsx7(Primitive.div, {
      dir: direction,
      "data-orientation": orientation,
      ...tabsProps,
      ref: forwardedRef
...
var TabsList = React13.forwardRef((props, forwardedRef) => {
  const { __scopeTabs, loop = true, ...listProps } = props;
  const context = useTabsContext(TAB_LIST_NAME, __scopeTabs);
  const rovingFocusGroupScope = useRovingFocusGroupScope(__scopeTabs);
  return /* @__PURE__ */ jsx7(Root, {
    asChild: true,
...
var TabsTrigger = React13.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx7(Item, {
    asChild: true,
    ...rovingFocusGroupScope,
    focusable: !disabled,
    active: isSelected,
    children: /* @__PURE__ */ jsx7(Primitive.button, {
      type: "button",
      role: "tab",
...
var TabsContent = React13.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx7(Presence, { present: forceMount || isSelected, children: ({ present }) => /* @__PURE__ */ jsx7(Primitive.div, {
    "data-state": isSelected ? "active" : "inactive",
    "data-orientation": context.orientation,
    role: "tabpanel",
