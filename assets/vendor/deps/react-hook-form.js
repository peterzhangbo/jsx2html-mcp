...
var get = (object, path, defaultValue) => {
  ...
  const result = paths.reduce((result2, key) => {
    return isNullOrUndefined(result2) ? undefined : result2[key];
  }, object);
...
var FormProvider = (props) => {
  ...
  return React.createElement(HookFormContext.Provider, { value: memoizedValue }, React.createElement(HookFormControlContext.Provider, { value: memoizedValue.control }, children));
};
...
function pruneDirtyFields(value) {
  ...
  if (Array.isArray(value)) {
    ...
    return result.some((value2) => value2 !== undefined) ? result : undefined;
  }
  if (isObject(value)) {
    const result = {};
...
function createFormControl(props = {}) {
  ...
  const clearErrors = (name) => {
    ...
    names === null || names === undefined || names.forEach((inputName) => unset(_formState.errors, inputName));
    if (names) {
...
var fillEmptyArray = (value) => Array.isArray(value) ? value.map(() => {
  return;
}) : undefined;
