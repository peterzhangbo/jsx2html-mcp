...
function createSlot(ownerName) {
  ...
  const Slot2 = React5.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx2(SlotClone, { ...slotProps, ref: forwardedRef, children: React5.isValidElement(newElement) ? React5.cloneElement(newElement, undefined, newChildren) : null });
    }
...
var DismissableLayer = React11.forwardRef((props, forwardedRef) => {
  const {
...
var FocusScope = React13.forwardRef((props, forwardedRef) => {
  ...
  const handleKeyDown = React13.useCallback((event) => {
    if (!loop && !trapped)
      return;
...
var Arrow = React16.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx8(Primitive.svg, {
    ...arrowProps,
    ref: forwardedRef,
    width,
    height,
...
var PopperContent = React18.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx9("div", {
    ...
    dir: props.dir,
    children: /* @__PURE__ */ jsx9(PopperContentProvider, {
      scope: __scopePopper,
      placedSide,
      ...
      children: /* @__PURE__ */ jsx9(Primitive.div, {
...
var RovingFocusGroup = React21.forwardRef((props, forwardedRef) => {
...
var RovingFocusGroupImpl = React21.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx11(RovingFocusProvider, {
    scope: __scopeRovingFocusGroup,
    orientation,
    dir: direction,
    loop,
    currentTabStopId,
    onItemFocus: React21.useCallback((tabStopId) => setCurrentTabStopId(tabStopId), [setCurrentTabStopId]),
    onItemShiftTab: React21.useCallback(() => setIsTabbingBackOut(true), []),
    onFocusableItemAdd: React21.useCallback(() => setFocusableItemsCount((prevCount) => prevCount + 1), []),
    onFocusableItemRemove: React21.useCallback(() => setFocusableItemsCount((prevCount) => prevCount - 1), []),
...
var RovingFocusGroupItem = React21.forwardRef((props, forwardedRef) => {
  const {
    __scopeRovingFocusGroup,
    focusable = true,
    active = false,
  ...
  return /* @__PURE__ */ jsx11(Collection.ItemSlot, {
    scope: __scopeRovingFocusGroup,
    id,
    focusable,
    active,
...
import { useState as useState13, useCallback as useCallback7, useEffect as useEffect13, useLayoutEffect as useLayoutEffect6 } from "react";
...
var Menu = (props) => {
  ...
  return /* @__PURE__ */ jsx12(Root2, { ...popperScope, children: /* @__PURE__ */ jsx12(MenuProvider, {
    scope: __scopeMenu,
    open,
    onOpenChange: handleOpenChange,
    content,
    onContentChange: setContent,
    children: /* @__PURE__ */ jsx12(MenuRootProvider, {
      scope: __scopeMenu,
...
var MenuAnchor = React35.forwardRef((props, forwardedRef) => {
...
var MenuContent = React35.forwardRef((props, forwardedRef) => {
...
var MenuRootContentModal = React35.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME2, props.__scopeMenu);
  ...
  return /* @__PURE__ */ jsx12(MenuContentImpl, {
    ...props,
    ref: composedRefs,
...
var MenuContentImpl = React35.forwardRef((props, forwardedRef) => {
  const {
    __scopeMenu,
    loop = false,
    trapFocus,
  ...
  return /* @__PURE__ */ jsx12(MenuContentProvider, {
    scope: __scopeMenu,
    searchRef,
    onItemEnter: React35.useCallback((event) => {
      if (isPointerMovingToSubmenu(event))
        event.preventDefault();
    }, [isPointerMovingToSubmenu]),
    onItemLeave: React35.useCallback((event) => {
      if (isPointerMovingToSubmenu(event))
        return;
      contentRef.current?.focus();
      setCurrentItemId(null);
    }, [isPointerMovingToSubmenu]),
    onTriggerLeave: React35.useCallback((event) => {
      if (isPointerMovingToSubmenu(event))
        event.preventDefault();
    }, [isPointerMovingToSubmenu]),
    ...
    children: /* @__PURE__ */ jsx12(ScrollLockWrapper, { ...scrollLockWrapperProps, children: /* @__PURE__ */ jsx12(FocusScope, {
      asChild: true,
      trapped: trapFocus,
      ...
      children: /* @__PURE__ */ jsx12(DismissableLayer, {
        asChild: true,
        disableOutsidePointerEvents,
        onEscapeKeyDown,
        onPointerDownOutside,
...
var MenuGroup = React35.forwardRef((props, forwardedRef) => {
  const { __scopeMenu, ...groupProps } = props;
  return /* @__PURE__ */ jsx12(Primitive.div, { role: "group", ...groupProps, ref: forwardedRef });
});
MenuGroup.displayName = GROUP_NAME2;
var LABEL_NAME = "MenuLabel";
var MenuLabel = React35.forwardRef((props, forwardedRef) => {
...
var MenuItem = React35.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(MenuItemImpl, {
    ...itemProps,
    ref: composedRefs,
    disabled,
...
var MenuItemImpl = React35.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Collection2.ItemSlot, {
    scope: __scopeMenu,
    disabled,
    textValue: textValue ?? textContent,
    children: /* @__PURE__ */ jsx12(Item, { asChild: true, ...rovingFocusGroupScope, focusable: !disabled, children: /* @__PURE__ */ jsx12(Primitive.div, {
      role: "menuitem",
...
var MenuCheckboxItem = React35.forwardRef((props, forwardedRef) => {
  const { checked = false, onCheckedChange, ...checkboxItemProps } = props;
  return /* @__PURE__ */ jsx12(ItemIndicatorProvider, { scope: props.__scopeMenu, checked, children: /* @__PURE__ */ jsx12(MenuItem, {
...
var MenuRadioGroup = React35.forwardRef((props, forwardedRef) => {
...
var MenuRadioItem = React35.forwardRef((props, forwardedRef) => {
...
var MenuItemIndicator = React35.forwardRef((props, forwardedRef) => {
  const { __scopeMenu, forceMount, ...itemIndicatorProps } = props;
  const indicatorContext = useItemIndicatorContext(ITEM_INDICATOR_NAME, __scopeMenu);
  return /* @__PURE__ */ jsx12(Presence, {
...
var MenuSeparator = React35.forwardRef((props, forwardedRef) => {
  const { __scopeMenu, ...separatorProps } = props;
  return /* @__PURE__ */ jsx12(Primitive.div, {
    role: "separator",
...
var MenuArrow = React35.forwardRef((props, forwardedRef) => {
...
var MenuSub = (props) => {
  ...
  return /* @__PURE__ */ jsx12(Root2, { ...popperScope, children: /* @__PURE__ */ jsx12(MenuProvider, {
    ...
    content,
    onContentChange: setContent,
    children: /* @__PURE__ */ jsx12(MenuSubProvider, {
      scope: __scopeMenu,
      contentId: useId(),
      triggerId: useId(),
      trigger,
...
var MenuSubTrigger = React35.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(MenuAnchor, { asChild: true, ...scope, children: /* @__PURE__ */ jsx12(MenuItemImpl, {
...
var MenuSubContent = React35.forwardRef((props, forwardedRef) => {
  const portalContext = usePortalContext(CONTENT_NAME2, props.__scopeMenu);
  ...
  const ref = React35.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  return /* @__PURE__ */ jsx12(Collection2.Provider, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx12(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx12(Collection2.Slot, { scope: props.__scopeMenu, children: /* @__PURE__ */ jsx12(MenuContentImpl, {
...
var DropdownMenu = (props) => {
  ...
  return /* @__PURE__ */ jsx13(DropdownMenuProvider, {
...
var DropdownMenuTrigger = React36.forwardRef((props, forwardedRef) => {
  const { __scopeDropdownMenu, disabled = false, ...triggerProps } = props;
  const context = useDropdownMenuContext(TRIGGER_NAME, __scopeDropdownMenu);
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx13(Anchor2, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsx13(Primitive.button, {
    type: "button",
...
var DropdownMenuContent = React36.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx13(Content2, {
...
var DropdownMenuGroup = React36.forwardRef((props, forwardedRef) => {
...
var DropdownMenuLabel = React36.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React36.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React36.forwardRef((props, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return /* @__PURE__ */ jsx13(SubContent, {
    ...menuScope,
    ...subContentProps,
    ref: forwardedRef,
    style: {
