...
var o = (e2, t2) => {
  ...
  for (let n2 in e2) {
    let c = e2[n2];
    n2[0] == "@" ? n2[1] == "i" ? r = n2 + " " + c + ";" : a2 += n2[1] == "f" ? o(c, n2) : n2 + "{" + o(c, n2[1] == "k" ? "" : t2) + "}" : typeof c == "object" ? a2 += o(c, t2 ? t2.replace(/([^,])+/g, (e3) => n2.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g, (t3) => /&/.test(t3) ? t3.replace(/&/g, e3) : e3 ? e3 + " " + t3 : t3)) : n2) : c != null && (n2 = n2[1] == "-" ? n2 : n2.replace(/[A-Z]/g, "-$&").toLowerCase(), l2 += o.p ? o.p(n2, c) : n2 + ":" + c + ";");
  }
...
var s = (e2, t2, r, s2, p) => {
  ...
  return r && (c.g = c[d]), ((e3, t3, r2, a2) => {
    a2 ? t3.data = t3.data.replace(a2, e3) : t3.data.indexOf(e3) === -1 && (t3.data = r2 ? e3 + t3.data : t3.data + e3);
  })(c[d], t2, s2, f), d;
};
...
var v = [];
var j = { toasts: [], pausedAt: undefined, settings: { toastLimit: re } };
var f2 = {};
var Y = (e2, t2 = k) => {
...
var w2 = (e2, t2 = "default") => {
  let { toasts: o2, pausedAt: s2 } = V(e2, t2), a2 = ne(new Map).current, i2 = A((c2, m2 = ce) => {
    if (a2.has(c2))
      return;
    let p2 = setTimeout(() => {
