...
var CSSTransition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /* @__PURE__ */ React3.createElement(Transition_default, _extends({}, props, {
...
var TransitionGroup = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    delete props.exit;
    if (Component === null) {
      return /* @__PURE__ */ React4.createElement(TransitionGroupContext_default.Provider, {
        value: contextValue
      }, children);
    }
    return /* @__PURE__ */ React4.createElement(TransitionGroupContext_default.Provider, {
      value: contextValue
    }, /* @__PURE__ */ React4.createElement(Component, props, children));
  };
...
var ReplaceTransition = /* @__PURE__ */ function(_React$Component) {
  ...
  _proto.handleLifecycle = function handleLifecycle(handler, idx, originalArgs) {
    ...
    var child = React5.Children.toArray(children)[idx];
    if (child.props[handler])
      (_child$props = child.props)[handler].apply(_child$props, originalArgs);
    if (this.props[handler]) {
      var maybeNode = child.props.nodeRef ? undefined : ReactDOM2.findDOMNode(this);
  ...
  _proto.render = function render() {
    ...
    var _React$Children$toArr = React5.Children.toArray(children), first = _React$Children$toArr[0], second = _React$Children$toArr[1];
    ...
    return /* @__PURE__ */ React5.createElement(TransitionGroup_default, props, inProp ? React5.cloneElement(first, {
      key: "first",
...
var leaveRenders = (_leaveRenders = {}, _leaveRenders[modes.out] = function(_ref) {
  ...
  var { current, changeState, children: children2 } = _ref2;
...
var enterRenders = (_enterRenders = {}, _enterRenders[modes.out] = function(_ref3) {
  var { children: children2, changeState } = _ref3;
  ...
  var { current, children: children2, changeState } = _ref4;
  return [React6.cloneElement(current, {
    in: false,
    onExited: callHook(current, "onExited", function() {
      changeState(ENTERED, React6.cloneElement(children2, {
