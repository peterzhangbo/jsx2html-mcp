...
var Arrow = React11.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx5(Primitive.svg, {
    ...arrowProps,
    ref: forwardedRef,
    width,
    height,
...
function useSize(element) {
  const [size4, setSize] = React12.useState(undefined);
  useLayoutEffect2(() => {
    if (element) {
...
var PopperAnchor = React13.forwardRef((props, forwardedRef) => {
...
var PopperContent = React13.forwardRef((props, forwardedRef) => {
  const {
    __scopePopper,
    side = "bottom",
    sideOffset = 0,
  ...
  return /* @__PURE__ */ jsx6("div", {
    ...
    dir: props.dir,
    children: /* @__PURE__ */ jsx6(PopperContentProvider, {
      scope: __scopePopper,
      placedSide,
...
var VisuallyHidden = React17.forwardRef((props, forwardedRef) => {
...
var TooltipProvider = (props) => {
  ...
  return /* @__PURE__ */ jsx9(TooltipProviderContextProvider, {
...
var Tooltip = (props) => {
  ...
  return /* @__PURE__ */ jsx9(Root2, { ...popperScope, children: /* @__PURE__ */ jsx9(TooltipContextProvider, {
    scope: __scopeTooltip,
    contentId,
    open,
    stateAttribute,
...
var TooltipTrigger = React18.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx9(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ jsx9(Primitive.button, {
...
var TooltipContent = React18.forwardRef((props, forwardedRef) => {
...
var TooltipContentHoverable = React18.forwardRef((props, forwardedRef) => {
  ...
  const handleCreateGraceArea = React18.useCallback((event, hoverTarget) => {
...
var TooltipContentImpl = React18.forwardRef((props, forwardedRef) => {
  const {
    __scopeTooltip,
    children,
  ...
  return /* @__PURE__ */ jsx9(DismissableLayer, {
    asChild: true,
    disableOutsidePointerEvents: false,
    onEscapeKeyDown,
    onPointerDownOutside,
    ...
    children: /* @__PURE__ */ jsxs(Content, {
      ...
      children: [
        /* @__PURE__ */ jsx9(Slottable, { children }),
...
var TooltipArrow = React18.forwardRef((props, forwardedRef) => {
