...
function useSize(element) {
  const [size4, setSize] = React16.useState(undefined);
  useLayoutEffect2(() => {
    if (element) {
...
function useControllableState({
  ...
  if (true) {
    const isControlledRef = React19.useRef(prop !== undefined);
    React19.useEffect(() => {
  ...
  const setValue = React19.useCallback((nextValue) => {
    if (isControlled) {
...
var VisuallyHidden = React21.forwardRef((props, forwardedRef) => {
  return /* @__PURE__ */ jsx11(Primitive.span, {
    ...props,
    ref: forwardedRef,
...
import { useState as useState11, useCallback as useCallback5, useEffect as useEffect11, useLayoutEffect as useLayoutEffect6 } from "react";
...
// node_modules/@radix-ui/react-select/dist/index.mjs
import { Fragment as Fragment7, jsx as jsx12, jsxs } from "react/jsx-runtime";
"use client";
...
var Select = (props) => {
  ...
  return /* @__PURE__ */ jsx12(Root2, { ...popperScope, children: /* @__PURE__ */ jsxs(SelectProvider, {
    required,
    scope: __scopeSelect,
    trigger,
    ...
    disabled,
    children: [
      /* @__PURE__ */ jsx12(Collection.Provider, { scope: __scopeSelect, children: /* @__PURE__ */ jsx12(SelectNativeOptionsProvider, {
      ...
      isFormControl ? /* @__PURE__ */ jsxs(SelectBubbleInput, {
        ...
        form,
        children: [
          value === undefined ? /* @__PURE__ */ jsx12("option", { value: "" }) : null,
...
var SelectTrigger = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Anchor, { asChild: true, ...popperScope, children: /* @__PURE__ */ jsx12(Primitive.button, {
    type: "button",
    role: "combobox",
...
var SelectValue = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Primitive.span, {
    ...valueProps,
    ref: composedRefs,
    style: { pointerEvents: "none" },
    children: shouldShowPlaceholder(context.value) ? /* @__PURE__ */ jsx12(Fragment7, { children: placeholder }) : children
  });
});
...
var SelectIcon = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Primitive.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
});
SelectIcon.displayName = ICON_NAME;
var PORTAL_NAME2 = "SelectPortal";
var SelectPortal = (props) => {
  return /* @__PURE__ */ jsx12(Portal, { asChild: true, ...props });
};
...
var SelectContent = React34.forwardRef((props, forwardedRef) => {
  ...
  if (!context.open) {
    const frag = fragment;
    return frag ? ReactDOM4.createPortal(/* @__PURE__ */ jsx12(SelectContentProvider, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx12(Collection.Slot, { scope: props.__scopeSelect, children: /* @__PURE__ */ jsx12("div", { children: props.children }) }) }), frag) : null;
  }
  return /* @__PURE__ */ jsx12(SelectContentImpl, { ...props, ref: forwardedRef });
});
...
var SelectContentImpl = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(SelectContentProvider, {
    scope: __scopeSelect,
    content,
    viewport,
    ...
    isPositioned,
    searchRef,
    children: /* @__PURE__ */ jsx12(Combination_default, { as: Slot, allowPinchZoom: true, children: /* @__PURE__ */ jsx12(FocusScope, {
      asChild: true,
      ...
      children: /* @__PURE__ */ jsx12(DismissableLayer, {
        ...
        children: /* @__PURE__ */ jsx12(SelectPosition, {
          role: "listbox",
...
var SelectItemAlignedPosition = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(SelectViewportProvider, {
    scope: __scopeSelect,
    contentWrapper,
...
var SelectViewport = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment7, { children: [
    ...
    /* @__PURE__ */ jsx12(Collection.Slot, { scope: __scopeSelect, children: /* @__PURE__ */ jsx12(Primitive.div, {
...
var SelectGroup = React34.forwardRef((props, forwardedRef) => {
  ...
  const groupId = useId();
  return /* @__PURE__ */ jsx12(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: /* @__PURE__ */ jsx12(Primitive.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
});
...
var SelectLabel = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Primitive.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
});
...
var SelectItem = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(SelectItemContextProvider, {
    scope: __scopeSelect,
    value,
    disabled,
    textId,
    ...
    children: /* @__PURE__ */ jsx12(Collection.ItemSlot, {
      scope: __scopeSelect,
      value,
      disabled,
      textValue,
...
var SelectItemText = React34.forwardRef((props, forwardedRef) => {
  ...
  const nativeOption = React34.useMemo(() => /* @__PURE__ */ jsx12("option", { value: itemContext.value, disabled: itemContext.disabled, children: textContent }, itemContext.value), [itemContext.disabled, itemContext.value, textContent]);
  ...
  return /* @__PURE__ */ jsxs(Fragment7, { children: [
    /* @__PURE__ */ jsx12(Primitive.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React34.forwardRef((props, forwardedRef) => {
  ...
  return itemContext.isSelected ? /* @__PURE__ */ jsx12(Primitive.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
});
...
var SelectScrollUpButton = React34.forwardRef((props, forwardedRef) => {
  ...
  return canScrollUp ? /* @__PURE__ */ jsx12(SelectScrollButtonImpl, {
    ...props,
    ref: composedRefs,
    onAutoScroll: () => {
...
var SelectScrollDownButton = React34.forwardRef((props, forwardedRef) => {
  ...
  return canScrollDown ? /* @__PURE__ */ jsx12(SelectScrollButtonImpl, {
    ...props,
    ref: composedRefs,
    onAutoScroll: () => {
      const { viewport, selectedItem } = contentContext;
...
var SelectSeparator = React34.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Primitive.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
});
...
var SelectArrow = React34.forwardRef((props, forwardedRef) => {
  ...
  return context.open && contentContext.position === "popper" ? /* @__PURE__ */ jsx12(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
});
SelectArrow.displayName = ARROW_NAME2;
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React34.forwardRef(({ __scopeSelect, value, ...props }, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsx12(Primitive.select, {
    ...props,
    style: { ...VISUALLY_HIDDEN_STYLES, ...props.style },
    ref: composedRefs,
    defaultValue: value
