...
function useSize(element) {
  const [size, setSize] = React6.useState(undefined);
  useLayoutEffect2(() => {
    if (element) {
...
function createSlot(ownerName) {
  ...
  const Slot2 = React8.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx2(SlotClone, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, undefined, newChildren) : null });
    }
...
function CheckboxProvider(props) {
  ...
  return /* @__PURE__ */ jsx4(CheckboxProviderImpl, {
...
var CheckboxTrigger = React10.forwardRef(({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
  const {
    control,
    value,
    disabled,
  ...
  return /* @__PURE__ */ jsx4(Primitive.button, {
    type: "button",
    role: "checkbox",
...
var Checkbox = React10.forwardRef((props, forwardedRef) => {
  const {
    __scopeCheckbox,
    name,
    checked,
  ...
  return /* @__PURE__ */ jsx4(CheckboxProvider, {
    __scopeCheckbox,
    checked,
    defaultChecked,
    disabled,
    ...
    internal_do_not_use_render: ({ isFormControl }) => /* @__PURE__ */ jsxs(Fragment3, { children: [
      /* @__PURE__ */ jsx4(CheckboxTrigger, {
        ...checkboxProps,
        ref: forwardedRef,
        __scopeCheckbox
      }),
      isFormControl && /* @__PURE__ */ jsx4(CheckboxBubbleInput, {
        __scopeCheckbox
      })
    ] })
  });
...
var CheckboxIndicator = React10.forwardRef((props, forwardedRef) => {
  const { __scopeCheckbox, forceMount, ...indicatorProps } = props;
  const context = useCheckboxContext(INDICATOR_NAME, __scopeCheckbox);
  return /* @__PURE__ */ jsx4(Presence, {
    present: forceMount || isIndeterminate(context.checked) || context.checked === true,
    children: /* @__PURE__ */ jsx4(Primitive.span, {
...
var CheckboxBubbleInput = React10.forwardRef(({ __scopeCheckbox, ...props }, forwardedRef) => {
  const {
    control,
    hasConsumerStoppedPropagationRef,
    checked,
  ...
  return /* @__PURE__ */ jsx4(Primitive.input, {
    type: "checkbox",
    "aria-hidden": true,
